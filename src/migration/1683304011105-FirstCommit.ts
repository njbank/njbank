...
export class FirstCommit1683304011105 implements MigrationInterface {
    name = 'FirstCommit1683304011105'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "User" ("id" character varying NOT NULL, "userName" character varying NOT NULL, "role" character varying NOT NULL DEFAULT 'Guest', "ipAddress" character varying NOT NULL, "amount" integer NOT NULL DEFAULT '0', "tokens" jsonb NOT NULL DEFAULT '{}', "oneTimeCode" character varying NOT NULL DEFAULT '', CONSTRAINT "PK_9862f679340fb2388436a5ab3e4" PRIMARY KEY ("id"))`);
