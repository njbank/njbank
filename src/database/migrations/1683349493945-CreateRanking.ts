...
export class CreateRanking1683349493945 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ranking_entry" ("id" SERIAL NOT NULL, "userId" character varying NOT NULL,  "board" integer NOT NULL, "amount" integer NOT NULL, CONSTRAINT "PK_d96715e4495075ef3427c9d0953" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_99e6bb0c9a1c03cc1e2337e3b7" ON "ranking_entry" ("board") `);
